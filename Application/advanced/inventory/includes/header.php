...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Tapsibog Inventory System</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li id="navDashboard" class="active"><a href="index.php"> <i class="glyphicon glyphicon-list-alt"></i> Dashboard</a></li>
        <li id="navRawItems"><a href="raw_items.php"> <i class="glyphicon glyphicon-btc"></i> Raw Items</a>
        </li>
        <li id="navCategory" ><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> Category</a></li>
