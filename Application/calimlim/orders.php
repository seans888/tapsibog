		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label"></label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				    <select class="form-control" name="paymentStatus" id="discount" onkeyup="discountFunc()" autocomplete="off">
				      	<option value="1">None</option>
				      	<option value="2">PWD (20%)</option>
				      	<option value="2">Senior (20%)</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
